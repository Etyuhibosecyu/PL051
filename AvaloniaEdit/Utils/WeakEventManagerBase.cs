	...
	where TEventManager : WeakEventManagerBase<TEventManager, TEventSource, TEventHandler, TEventArgs>, new()
{
	...
	internal class WeakHandler(object source, TEventHandler originalHandler)
	{
		...
		public bool IsActive => _source is not null && _source.IsAlive && _originalHandler is not null && _originalHandler.IsAlive;

		public TEventHandler Handler
		{
			get
			{
				if (_originalHandler is null)
				{
					return default;
				}
		...
		public bool Matches(object o, TEventHandler handler) => _source is not null &&
				   ReferenceEquals(_source.Target, o) &&
				   _originalHandler is not null &&
...
{
	public bool IsDisposed => dispose is null;
